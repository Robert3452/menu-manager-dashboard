...
import { Trash } from '../../../../icons/trash';
import { deleteBranch as removeBranch, updateBranch } from '../../../../slices/branches';
import { useDispatch } from '../../../../store';


export const BranchGeneralSettings = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, helpers) => {
            try {
                const response = await dispatch(updateBranch(branch.id, values));
    ...
    const deleteBranch = async () => {
        ...
        const res = await dispatch(removeBranch(router.query.branchId));
